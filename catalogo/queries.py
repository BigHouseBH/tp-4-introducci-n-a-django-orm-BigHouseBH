...
#Mientras en models se define "como guardar" en quearies(consulta) se define "como retirar"
...
def libros_por_categoria(nombre_categoria: str):
    ...
    #[nombre de modelo].objets: "dame todos los objetos de este modelo"
...
def autores_con_mas_de_n_libros(n: int):
    ...
    #annotate:crea una hoja de calculo temporal(no se almacena en la BD) y almaneca en cada fila el atributo en parametro
    #Count("libro") cuenta la cantidad de libros relacionados a cada autor
    #luego filtra de esta ""notas""(la hoja de calculo temporal)
...
def libros_sin_disponibilidad():
    ...
    #Q es una clase que permite construir consultas complejas con operadores lógicos (AND, OR, NOT)
